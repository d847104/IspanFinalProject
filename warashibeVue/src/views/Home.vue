    ...
    <div class="container p-4">
        <div id="carouselExampleFade" class="carousel slide carousel-fade">
            <div class="carousel-inner">
                <div class="carousel-item active" v-for="product in productsPopular" :key="product.productID" :product="product">
                    <img :alt="product.productName" :src="path" class="d-block w-100">
                </div>
            </div>
...
const props = defineProps(["productImg"]);
const path = computed(()=>{
        if(props.img){
                return `${import.meta.env.VITE_API_URL}/api/productImg/img/all`
        } else {
